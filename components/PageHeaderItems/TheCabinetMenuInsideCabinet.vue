<template>
    <nav class="page-header__menu menu menu--cabinet" ref="cabinetMenu">
        ...
        <div class="menu__closer" @click="showCabinetMenu(null)"></div>
        <div class="menu__top">
        ...
        <div class="menu__list-holder">
            <ul class="menu__list menu__list--client" v-if="$auth.$state.user.type === 'client'">
                <li class="menu__item" >
                    <div @click="showCabinetMenu('tab1')" >Быстрый подбор</div>
                </li>
                <li class="menu__item" >
                ...
                <li class="menu__item menu__item--black">
                    <div
                            @click="showCabinetMenu('tab4')"                          >Профиль</div>
                </li>
            ...
            <ul class="menu__list" v-else>
                ...
                <!--</li>-->
                <li class="menu__item" >
                    <div @click="showCabinetMenu('tab1')" >Мои события</div>
                </li>
                <li class="menu__item" >
                    <div @click="showCabinetMenu('tab2')" >Мой календарь</div>
                </li>
                <li class="menu__item" >
                    <nuxt-link  to="/cabinet/chat">Мои сообщения</nuxt-link>
                </li>
                ...
                <li class="menu__item menu__item--black">
                    <div  @click="showCabinetMenu('tab3')" >Профиль</div>
                </li>
                <!--<li class="menu__item menu__item&#45;&#45;black">-->
