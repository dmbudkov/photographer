<template>
  <div class="datepicker datepicker--catalog" :class="`${ isOpen ? 'datepicker--catalog-open' : '' }`">
...
" :value="`${checkIn ? formatDate(checkIn) : ''}`"
    ...
    <div class="datepicker" :class="`${ !isOpen ? 'datepicker--closed' : 'datepicker--open' }`">
      ...
      <div class="datepicker__inner">
        ...
        <div class="datepicker__months" id="swiperWrapper" v-if="screenSize === 'desktop'">
          ...
          <div class="datepicker__show-more" @click="renderOnTap" v-if="screenSize !== 'desktop'">
            Загрузить еще
          </div>
        ...
        <div class="datepicker__week-holder" v-if="screenSize !== 'desktop' && isOpen">
          ...
          <div class="datepicker__months" ref="monthsContainer" id="swiperWrapper">
            ...
            <div class="datepicker__show-more" v-if="screenSize !== 'desktop'" @click="renderOnTap">
              Загрузить еще
            </div>
...
export default {
  ...
  watch: {
    isOpen (value) {
      if (this.screenSize !== 'desktop') {
        ...
        const wrapperClassList = document.querySelector('.page-wrapper').classList;

        if (value) {
          bodyClassList.add('-overflow-hidden');
          mainClassList.add('main--date-opened');
            wrapperClassList.add('page-wrapper--date-opened');
        }
        else {
          bodyClassList.remove('-overflow-hidden');
          mainClassList.remove('main--date-opened');
           wrapperClassList.remove('page-wrapper--date-opened');
        }
      }
    },
    checkIn(newDate) {
  ...
  methods: {
    confirmSelectionEvent() {
        ...
        this.$parent.$parent.$parent.handleDateAcceptation();
        this.isOpen = false;
    },
