            ...
            <main class="main">
                ...
                <section class="page-section page-section--about">
                    ...
                    О проекте
                        ...
                        <p>     Ещё одна вкуснятина - Вы можете найти ещё лучше, но за те же деньги, просмотрев горящие предложения.</p>
                        <p>Будьте прогрессивными, начините своё событие здесь.</p>
                        <p>Приятного поиска.</p>
                </div>
                </section>
                </main>
        </div>
