<template>
    <div id="app-holder" ref="appHolder" :class="{'mobile': $store.state.mobileView}">
    <div class="wrapper wrapper--visible">
        <div class="page-wrapper page-wrapper--reg">
            <page-header class="page-header--reg"></page-header>
            <main class="main main--reg">
                ...
                <div class="filter-tab filter-tab--reg">
                    <div class="filter-tab__top">
                        ...
                        <div class="filter-tab__tabs">
                            <nuxt-link to="/registration/client/" exact-active-class="filter-tab__tabs-item--active"  class="filter-tab__tabs-item">
                        Заказчик
                            </nuxt-link>
                            <nuxt-link to="/registration/vendor/"  exact-active-class="filter-tab__tabs-item--active"  class="filter-tab__tabs-item">
                            Исполнитель
                            </nuxt-link>
                        </div>
                        <p class="filter-tab__description" v-if="$route.name === 'registration-client'">
